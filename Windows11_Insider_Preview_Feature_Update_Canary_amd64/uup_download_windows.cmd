@echo off
:: Generated on 2026-01-18 11:41:08 GMT
...
:START_PROCESS
title 28020.1371_amd64_zh-cn_professional_27bd90b0 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=27bd90b0-7fb1-4de1-a402-f38ee58466ca&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=27bd90b0-7fb1-4de1-a402-f38ee58466ca&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
